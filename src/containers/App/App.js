    ...
    <div className='main'>
      <div className='left section'>
        <div className='settings'>
          <DropDown settings={settings} setMode={setMode} play={play} />
...
const mapDispatchToProps = dispatch => ({
  ...
  setMode: options => {
    dispatch(setModeAction(options));
  },
  setName: name => {
    dispatch(setNameAction(name));
  },
  gameStart: () => {
    dispatch(gameStartedAction());
  },
  gameRestart: fieldSize => {
    dispatch(gameRestartedAction(fieldSize));
  },
  setGreen: options => {
    dispatch(setGreenAction(options));
  },
  settingRed: options => {
    dispatch(settingRedAction(options));
  },
  cancelSettingRed: options => {
    dispatch(settingRedCancelledAction(options));
  }
});
